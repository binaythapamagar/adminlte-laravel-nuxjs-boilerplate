...
<header class="main-header">
    ...
    <a href="{{ route('dashboard::index') }}" class="logo">
        ...
        <span class="logo-mini">{{ isset( $title ) ? $title : substr(App\Utils\Options::get('siteconfig')['system_name'],0,4) }}</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">{{ isset( $title ) ? $title : App\Utils\Options::get('siteconfig')['system_name'] }}</span>
    </a>
